...
INSERT INTO users(username, email, password, photo) VALUES ('admin','admin@localhost.com','https://i.pinimg.com/564x/31/1b/2d/311b2def17cba6b7f05ac1d2ea976786.jpg' , 'admin');
INSERT INTO users(username, email, password, photo) VALUES ('user','user@localhost.com', 'https://i.pinimg.com/564x/aa/9a/91/aa9a91a270416d5bb3018f837c02c535.jpg', 'user');
